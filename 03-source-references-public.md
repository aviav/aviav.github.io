# Sub-Article 3: Source References

**Article**: "Addition Through Subtraction: When Capability Enhancement Requires Letting Go"
**Generated**: 2025-12-04
**Purpose**: Line-by-line source verification for all claims

---

## Line 13-15: Inuit Hunter Quote

**Article text**:
> "Up here we say that by gifts one makes slaves and by whips one makes dogs."

**Source**: David Graeber, *Debt: The First 5000 Years* (2011)
**Status**: VERIFIED
...
## Line 21: Spanish Huerta Summary Statistic
...
## Line 44-47: Port Lameron Fisher Quote
...
## Line 50: Port Lameron "Fragile" Classification
...
## Line 50: Federal Open-Access Policy
...
## Line 50: Nested Rules Prescription
...
## Line 52-55: Swiss Village Assembly Autonomy Quote
...
**Source**: Author's interpretation of Swiss assembly quote
**Status**: INTERPRETIVE FRAMING - not factual claim

---

## Line 60: David Clark 1992 Quote
...
## Line 62: Clark/Saltzer/Reed Attribution

**Article text**:
> "From Clark, Jerome Saltzer, and David Reed on the end-to-end principle"

**Source**: Lessig citing original authors
**Status**: VERIFIED
...
## Line 62-65: End-to-End Principle Quote
...
## Line 74: Trust Networks Independence
...
> "Appeal to the Islamic courts was generally voluntary or mediated by merchant guilds and civic associations."

---

## Line 82: Spanish Huerta 99.2% Conformance
...
## Line 82: Spanish Huerta "Few Pennies" Quote
...
## Line 82: "With Many Onlookers" Quote
...
## Line 82: Spanish Huerta Centuries Duration
...
## Line 84: 1517 Rules Still Enforced

**Article text**:
> "Specific rules documented from 1517 remain enforced today."

**Source**: Ostrom citing Netting
**Status**: VERIFIED
...
## Line 86: Japanese Village Commons Duration

**Article text**:
> **Nearly 400 years** from 1600 through 1986

**Source**: Ostrom (1990), citing McKean (1986)
**Status**: VERIFIED
...
## Line 86: McKean Hectare Numbers
...
## Line 86: McKean "Not Necessary" Quote
...
## Line 88: Islamic Credit Independence
...
## Line 90: Internet "No Central Control"
...
## Line 92: Wikipedia Scale and Structure
...
**Source**: Contemporary data
**Status**: VERIFIED - externally verified by Tobi

---

## Line 94: Linux Infrastructure Claim

**Article text**:
> **Majority of global server infrastructure** produced through "part-time hacking by several thousand developers."

**Source**: Eric S. Raymond, *A Brief History of Hackerdom* (2000)
**Status**: PARTIALLY VERIFIED - scale supported, exact phrasing differs
...
## Line 94: Bazaar Model Outperformance
...
## Line 96: Venice Commenda Percentages

**Article text**:
> new participants comprised **69%, 81%, and 65%** of traders in sampled years

**Source**: Acemoglu & Robinson, *Why Nations Fail* (2012)
**Status**: VERIFIED
...
## Line 96: Venice "Young Entrepreneurs" Quote
...
## Line 106: Hayek "Knowledge" Quote
...
## Line 108: Scott Metis/Techne Distinction
...
## Line 110: Taleb "Antifragility"

**Article text**:
> Articulated "antifragility"—distributed, redundant systems with skin-in-the-game

**Source**: Nassim Taleb, *Antifragile* (2012) — **VERIFIED VIA SECONDARY SOURCE**
**Status**: VERIFIED - via Ferguson's description of Taleb's concept
...
**Source quotes**:
> "The problem, she said, is not that 'code is law' or that 'code regulates.'"
> "Of course, for the computer scientist code is law."

---

## Line 114: Weber "Direct Democracy"
...
## Line 116: Graeber Gift Economy Duration

**Article text**:
> "functioning effectively for millennia across cultures"

**Source**: Graeber (2011)
**Status**: PARTIALLY VERIFIED - concept extensively supported, phrasing is interpretive synthesis
...
## Line 124: Ferguson Networks Quote
...
## Line 136-144: Ruvuma Development Association
...
## Line 140: Scott "Nonauthoritarian Cooperation"
...
## Line 140: Ruvuma Economic Viability Quote
...
## Line 142: Tobacco Cultivation Order
...
## Line 148: English Village Credit
...
> "As a result, Margaret Sharples was hanged." (Example of credit being prosecuted as theft)

---

## Line 150: Medieval Mining Cooperatives
...
## Line 152: Banda Islands Governance
...
## Line 152: Banda Islands Genocide
...
## Line 154: Mossadegh Democratic Process
...
## Line 162: Philippine Irrigation Mention

**Article text**:
> "Swiss pastures, Internet protocols, Islamic bazaars, Inuit hunting, Philippine irrigation"

**Source**: Ostrom (1990) discusses Philippine zanjeras
**Status**: VERIFIED
...
## Line 191: Sub-Article 1 Evidence Count
...
- Discrepancy noted in `01-evidence.md`: meta-synthesis may predate buckets 12-13, or used filtering/deduplication
- The 439/15 figures are from the original meta-synthesis document and are accurately cited
...
1. **Line 94**: Linux "several thousand developers" - ESR says "huge numbers of volunteers" and "hundreds of users" but not exact phrasing; "majority of server infrastructure" is contemporary data
2. **Line 116**: Graeber "millennia across cultures" - concept extensively supported, phrasing is interpretive synthesis

...
- 6 claims WEAKENED (stripped qualifiers, added framing, interpretive layering)
- 1 claim REFUTED (omitted exculpatory context that reverses the meaning)
...
Anyone can check whether I accurately represented what happened, or whether I'm doing the same thing I just described catching myself doing.
